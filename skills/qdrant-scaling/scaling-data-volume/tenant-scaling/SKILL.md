...
- Understand multitenancy patterns [Multitenancy](/md/documentation/manage-data/multitenancy/)
...
Read about [Partition by payload](/md/documentation/manage-data/multitenancy/?s=partition-by-payload) and [Calibrate performance](/md/documentation/manage-data/multitenancy/?s=calibrate-performance) for best practices on indexing and query performance.


## Number of Tenants is around 100k and more

At this scale, the cluster may consist of several peers.
To localize tenant data and improve performance, use [custom sharding](/md/documentation/distributed_deployment/?s=user-defined-sharding) to assign tenants to specific shards based on tenant ID hash.
...
If some tenants are much larger than others, use [tiered multitenancy](/md/documentation/manage-data/multitenancy/?s=tiered-multitenancy) to promote large tenants to dedicated shards while keeping small tenants on shared shards. This optimizes resource allocation and performance for tenants of varying sizes.
