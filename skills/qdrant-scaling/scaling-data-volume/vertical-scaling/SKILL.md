...
- With scalar quantization: divide by 4 (INT8 reduces each float32 to 1 byte) [Quantization](/md/documentation/manage-data/quantization/)
- With binary quantization: divide by 32 [Binary quantization](/md/documentation/manage-data/quantization/?s=binary-quantization)
