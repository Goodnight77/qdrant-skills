...
- See how to use [Multistage queries](/md/documentation/search/hybrid-queries/?s=multi-stage-queries), for example with late interaction rerankers through [Multivectors](/md/documentation/manage-data/vectors/?s=multivectors).
- Cross-encoder rerankers via FastEmbed [Rerankers](/md/documentation/fastembed/fastembed-rerankers/)
...
- RF Query is currently based on a [3-parameter naive formula](/md/documentation/search/search-relevance/?s=naive-strategy) with no universal defaults, so it must be tuned per dataset, retriever, and feedback model
...
- Check the configuration of the [Relevance Feedback Query API](/md/documentation/search/search-relevance/?s=relevance-feedback)
- Use this as a helper end-to-end text retrieval example with parameter tuning and evals to understand how to use the API and run the `qdrant-relevance-feedback` framework: [RF tutorial](/md/documentation/tutorials-search-engineering/using-relevance-feedback/)
...
- Use MMR (v1.15+) as a query parameter with `diversity` to balance relevance and diversity [MMR](/md/documentation/search/search-relevance/?s=maximal-marginal-relevance-mmr)
...
- Recommendation API: positive/negative examples to recommend fitting vectors [Recommendation API](/md/documentation/search/explore/?s=recommendation-api)
  - Best score strategy: better for diverse examples, supports negative-only [Best score](/md/documentation/search/explore/?s=best-score-strategy)
- Discovery API: context pairs (positive/negative) to constrain search regions without a request target [Discovery](/md/documentation/search/explore/?s=discovery-api)
...
Check how to set up in [Score Boosting docs](/md/documentation/search/search-relevance/?s=score-boosting)
