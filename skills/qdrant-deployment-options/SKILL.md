...
- Use local mode (Python only): zero-dependency, in-memory or disk-persisted, no server needed [Local mode](/md/documentation/quickstart/)
- Local mode data format is NOT compatible with server. Do not use for production or benchmarking.
- For a real server locally, use Docker [Quick start](/md/documentation/quickstart/?s=download-and-run)
...
- Docker is the default deployment. Full Qdrant Open Source feature set, minimal setup. [Quick start](/md/documentation/quickstart/?s=download-and-run)
- You own operations: upgrades, backups, scaling, monitoring
- Must set up distributed mode manually for multi-node clusters [Distributed deployment](/md/documentation/distributed_deployment/)
- Consider Hybrid Cloud if you want Qdrant Cloud management on your infrastructure [Hybrid Cloud](/md/documentation/hybrid-cloud/)
...
- Qdrant Cloud handles upgrades, scaling, backups, and monitoring [Qdrant Cloud](/md/documentation/cloud-quickstart/)
...
- Qdrant EDGE: in-process bindings to Qdrant shard-level functions, no network overhead [Qdrant EDGE](/md/documentation/edge/edge-quickstart/)
